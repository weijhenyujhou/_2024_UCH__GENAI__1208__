...
model.add(tf.keras.layers.Conv2D(filters=18, kernel_size=(2, 2),padding="same", activation='relu'))
model.add(tf.keras.layers.Flatten())
model.add(tf.keras.layers.Dense(28*28*28, activation='relu'))
model.add(tf.keras.layers.Dense(28*28*14, activation='relu'))
